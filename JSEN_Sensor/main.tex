...
\label{sec:csrrEval}
 ...
 However, the PLSR model trained following the scheme presented in section~\ref{ssec:plsRegressor} shows a good robustness against new repetitions of unknown samples.  
